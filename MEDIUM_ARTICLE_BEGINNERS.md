...
## Video 1: Install Cursor (15 minutes)
...
Four prompts. One hour. You just built software.
...
**[Full Methodology (DADS VIBE CODE)](https://github.com/YOLOVibeCode/calc-tutorial/blob/main/DADS_VIBE_CODE.md)**
...
**Documentation:**
- Methodology: https://github.com/YOLOVibeCode/calc-tutorial/blob/main/DADS_VIBE_CODE.md
- Prompts: https://github.com/YOLOVibeCode/calc-tutorial/blob/main/Prompts.md

**Tools:**
- Cursor IDE: https://cursor.sh (free)
...
*No sales pitch. Just teaching. Pass it forward.*
